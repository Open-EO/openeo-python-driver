...
- Add initial support for `reduce_spatial` ([Open-EO/openeo-geopyspark-driver#1715](https://github.com/Open-EO/openeo-geopyspark-driver/issues/1715))
- Allow specifying `infra_id` when setting a job status
...
- Less strict parquet column name normalisation. ([#469](https://github.com/Open-EO/openeo-python-driver/issues/469))
